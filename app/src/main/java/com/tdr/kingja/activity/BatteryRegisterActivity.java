 ...
 */
public class BatteryRegisterActivity extends BaseTitleActivity {
    ...
    public static void goActivity(Context context, BatteryInfo batteryInfo) {
        Intent intent = new Intent(context, BatteryRegisterActivity.class);
