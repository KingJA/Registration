...
public class DX_PreRegistrationQueryActivity extends Activity {
    ...
    private void initview() {
        ...
        IV_Scan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityUtil.goActivityForResultWithBundle(DX_PreRegistrationQueryActivity.this, QRCodeScanActivity.class, bundle, SCANNIN_QR_CODE);
            }
        });
