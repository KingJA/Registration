 ...
 * 预登记车辆查询展示界面
 */
public class PreCheckShowActivity extends BaseActivity {
    ...
    RelativeLayout RL_CatType;
    @BindView(R.id.RL_vehiclePromise)
    RelativeLayout RL_vehiclePromise;
    @BindView(R.id.RL_CarTheft)
    RelativeLayout RL_CarTheft;
    @BindView(R.id.RL_BatteryTheft)
    RelativeLayout RL_BatteryTheft;

    private DX_PreRegistrationModel model;
...
//                Toast.makeText(mActivity,PLI.get(position).getREMARK(),Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        relativePlateType.setVisibility(View.GONE);
        RL_CatType.setVisibility(View.GONE);
        RL_vehiclePromise.setVisibility(View.GONE);
        RL_CarTheft.setVisibility(View.GONE);
        RL_BatteryTheft.setVisibility(View.GONE);
    ...
    private void initData() {
        ...
        model=(DX_PreRegistrationModel)TransferUtil.retrieve("CarData");
        if(model==null){
            model=new DX_PreRegistrationModel();
        }else{
            TransferUtil.remove("CarData");
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.text_deal:
                ...
                ActivityUtil.goActivityWithBundle(PreCheckShowActivity.this, FeedBackCommandActivity.class, bundle);
                break;
