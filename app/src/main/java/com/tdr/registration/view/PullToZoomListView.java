...
public class PullToZoomListView extends ListView implements AbsListView.OnScrollListener{
    ...
    private static final android.view.animation.Interpolator sInterpolator = new android.view.animation.Interpolator() {
    ...
    private void init(Context paramContext){
        ...
        this.mHeaderContainer = (RelativeLayout) View.inflate(paramContext, R.layout.layout_headview, null);
        this.mHeaderImage = (ImageView) this.mHeaderContainer.findViewById(R.id.image_zoomView);
