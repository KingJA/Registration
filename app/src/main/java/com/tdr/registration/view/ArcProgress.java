...
public class ArcProgress extends ProgressBar {
    ...
    private final int DEFAULT_LINEHEIGHT = dp2px(9);
    private final int DEFAULT_mTickWidth = dp2px(3);
    private final int DEFAULT_mRadius = dp2px(60);
    private final int DEFAULT_mUnmProgressColor = 0xffffffff;
