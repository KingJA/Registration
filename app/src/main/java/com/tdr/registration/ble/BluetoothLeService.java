package com.tdr.registration.ble;
...
//				stringBuilder.append(String.format("%02X ", byteChar & 0XFF));
//
//				Log.i(TAG, "***broadcastUpdate: byteChar = " + byteChar);
//
//			}
            String aa = Utils.bytesToHexString(data);
            intent.putExtra(EXTRA_DATA, data);
//			System.out.println("broadcastUpdate for  read data:" + aa);
        }
        sendBroadcast(intent);
    }
	 ...
	 */
    /**
     * @Title: disconnect @Description: TODO(取消蓝牙连接) @param 无 @return
     *         void @throws
     */
     ...
     */
    /**
     * @Title: close @Description: TODO(关闭所有蓝牙连接) @param 无 @return void @throws
     */
    public void close() {
     ...
     */
    /**
     * @Title: readCharacteristic @Description: TODO(读取特征值) @param @param
     *         characteristic（要读的特征值） @return void 返回类型 @throws
     */
     ...
     */
    /**
     * @Title: setCharacteristicNotification @Description:
     *         TODO(设置特征值通变化通知) @param @param characteristic（特征值） @param @param
     *         enabled （使能） @return void @throws
     */
    ...
    /**
     * @Title: getCharacteristicDescriptor @Description:
     *         TODO(得到特征值下的描述值) @param @param 无 @return void @throws
     */
     ...
     */
    /**
     * @Title: getSupportedGattServices @Description:
     *         TODO(得到蓝牙的所有服务) @param @return 无 @return List
     *         <BluetoothGattService> @throws
     */
