...
public class NoticeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mGson = new Gson();
        mAdapter = new CommandCenterAdapter(commandModels, getActivity(),1);
    }
    ...
    private void dialogShow(String message) {
        ...
        textStartTime.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    onCreateDialog(R.id.text_startTime).show();
                }
                return true;
            }
        });
        ...
        textEndTime.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    onCreateDialog(R.id.text_endTime).show();
                }
                return true;
            }
        });
                        ...
                        new DatePickerDialog.OnDateSetListener() {
                            public void onDateSet(DatePicker dp, int year,
                                ...
                                String d = dayOfMonth < 10 ? "0" + dayOfMonth : ""
                                        + dayOfMonth;
                                textStartTime.setText(year + "-" + m + "-" + d);
                            }
